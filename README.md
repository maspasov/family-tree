...
След първоначалния bootstrap **не се налага** да редактирате тези масиви
директно от Firebase конзолата — всеки редактор може да управлява списъците
от самото приложение: иконата ⚙️ „Роли“ до превключвателя на езика (горе
вдясно) отваря диалог за добавяне/премахване на редактори и наблюдатели.
Firestore правилата позволяват само редактиране на полетата `editors`/
`viewers` (нищо друго в документа) и не позволяват списъкът с редактори да
остане празен.
